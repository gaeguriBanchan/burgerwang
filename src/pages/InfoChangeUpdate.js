    ...
    <div>
      ...
      <div className="container max-w-6xl px-5 py-12">
        <div className="container w-9/12">
            ...
            <div className="px-16 py-6 text-2xl">
              ...
              <div className="flex  items-center text-2xl pb-6">
                ...
                <div className="flex items-center w-full font-black">
                  <p className=" mr-4">000-0000-0000</p>
                  <div>
          ...
          <JoinOptional />
          <Link to="/pwChange" className=" pt-10 flex justify-center">
            <button className="w-80 font-JUA bg-2e2e2e text-2xl text-white rounded-xl h-16 px-3">
              비밀번호 변경
            </button>
          </Link>
        </div>
